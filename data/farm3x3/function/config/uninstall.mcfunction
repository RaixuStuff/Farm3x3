...
tellraw @s " "
tellraw @s {"text":"[Click here to also remove data from official Farm3x3 addons/compatibility mods.]","color":"gold","clickEvent":{"action":"run_command","value":"/function farm3x3:config/uninstall_addons"}}
tellraw @s {"text":"[Click here to also remove legacy Farm3x3 scoreboard entries. Run this if you installed Farm3x3 before version 2.0.1 or before July 9th 2025.]","color":"blue","clickEvent":{"action":"run_command","value":"/function farm3x3:config/legacy_uninstall"}}
