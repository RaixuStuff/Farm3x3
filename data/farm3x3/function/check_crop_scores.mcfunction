...
execute if score @s farm3x3-wheat-mined matches 1.. run function farm3x3:harvest/crop_mined {Crop:"minecraft:wheat"}
...
execute if score @s farm3x3-potatoes-mined matches 1.. run function farm3x3:harvest/crop_mined {Crop:"minecraft:potatoes"}
...
execute if score @s farm3x3-carrots-mined matches 1.. run function farm3x3:harvest/crop_mined {Crop:"minecraft:carrots"}
...
execute if score @s farm3x3-beetroots-mined matches 1.. run function farm3x3:harvest/crop_mined {Crop:"minecraft:beetroots"}
...
execute if score @s farm3x3-nether_wart-mined matches 1.. run function farm3x3:harvest/crop_mined {Crop:"minecraft:nether_wart"}